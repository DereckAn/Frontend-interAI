...
import { Briefcase, Check, Copy, FileText, X } from "lucide-react";
...
export const JobDescription = () => {
  ...
  // Store
  const setJobDescription = useFormDataStore(
  ...
  const handleTextChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    setJobDescription(newValue); // Save to global store
  };
  ...
  const handleClear = () => {
    setDescription("");
    setJobDescription(""); // Clear in global store
    setIsCleared(true);
    ...
    <section className="w-full my-8">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-medium">Add job details</h3>
        </div>
